    ...
    signin && (
      <>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[99999999]">
          <div className="relative bg-white shadow-lg w-[310px] sm:w-[468px] md:w-[568px] rounded px-8 py-6 flex flex-col gap-6">
            {/* Header */}
            <header className="flex flex-col justify-start">
              <div className="flex items-center justify-between">
                <h1 className="text-[#6E7491] text-[20px] sm:text-[24px] leading-5 sm:leading-8 font-bold">
              ...
              <p className="text-sm sm:text-[18px] leading-4 sm:leading-6 text-[#7C8DB0] mt-2">
                 is totally free to use. Sign up using your email address or
                phone number below to get started.
              </p>
            </header>
            ...
            <div className="flex flex-col gap-2">
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="text-[#7C8DB0] outline-none"
                />
                <span className="text-[#7C8DB0] text-sm sm:text-base">
                  I agree to the <span className="text-[#605DEC]">terms and conditions</span>
                </span>
              </label>
              <label className="flex items-center gap-2">
                <input
